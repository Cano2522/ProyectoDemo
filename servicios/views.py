...
def agregarCategoria(request):
    ...
    return render(request, 'servicios/nuevoCategoria.html', {'formaCategoria': formaCategoria})
...
def editarCategoria(request, id):
    ...
    return render(request, 'servicios/editarCategoria.html', {'formaCategoria': formaCategoria})
...
def agregarNivel2(request, nivel1_id):
    ...
    return render(request, 'servicios/nuevoNivel2.html', {'formaNivel2': formaNivel2, "nivel1_id": nivel1_id})
...
def editarNivel2(request, id, nivel1_id):
    ...
    return render(request, 'servicios/editarNivel2.html', {'formaNivel2': formaNivel2, "nivel1_id": nivel1_id})
...
def agregarNivel3(request, nivel2_id, nivel1_id):
    ...
    return render(request, 'servicios/nuevoNivel3.html', {'formaNivel3': formaNivel3, "nivel2_id": nivel2_id, "nivel1_id": nivel1_id})
...
def editarNivel3(request, id, nivel2_id, nivel1_id):
    ...
    return render(request, 'servicios/editarNivel3.html', {'formaNivel3': formaNivel3, "nivel2_id": nivel2_id, "nivel1_id": nivel1_id})
...
def agregarNivel4(request, nivel3_id, nivel2_id, nivel1_id):
    ...
    return render(request, 'servicios/nuevoNivel4.html', {'formaNivel4': formaNivel4, "nivel3_id": nivel3_id,"nivel2_id": nivel2_id, "nivel1_id": nivel1_id})
...
def editarNivel4(request, id, nivel3_id, nivel2_id, nivel1_id):
    ...
    return render(request, 'servicios/editarNivel4.html', {'formaNivel4': formaNivel4, "nivel3_id": nivel3_id,"nivel2_id": nivel2_id, "nivel1_id": nivel1_id})